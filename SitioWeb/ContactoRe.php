...
<body>
  ...
  <header class="header">
   ...
   <section class="flex">
    ...
    <div class="heading">
        <h3>Contacto</h3>
        <p><a href="Inicio.html">Inicio </a> <span> / Contacto</span></p>
    </div>
     ...
     <section class="contacto">
        ...
        <div class="row">
           ...
           <div class="image">
              <img src="imagenes/ICONconta.jpg" alt="">
           </div>
     
           <form action="" method="post">
              <label for="">Nombre</lasbel>
              ...
              <input type="number" name="number" required placeholder="Escribe tú número de telefono" max="9999999999" min="0" class="box" onkeypress="if(this.value.length == 10) return false;">
              <label for="">Correo electronico</label>
              <input type="email" name="email" required placeholder="Escribe tú email" maxlength="50" class="box">
              <label for="">Sugerencia</label>
              <textarea name="msg" placeholder="Escribe tú sugerencia" required class="box" cols="30" rows="10" maxlength="500"></textarea>
