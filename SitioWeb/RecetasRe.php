...
<       <div class="profile">
 ...
 <section class="categorias">
    ...
    <div class="box-container">
       ...
       <a href="ReMexicanasRe.php" class="box">
          <img src="imagenes/1M.png" alt="">
          <h3>Mexicana</h3>
       </a>
    
       <a href="ReLibanesaRe.php" class="box">
          <img src="imagenes/2.png" alt="">
          <h3>Libanesa</h3>
       </a>
    
       <a href="ReItalianaRe.php" class="box">
 ...
 <section class="recetas">
   ...
   <div class="alinear">
      <div class="card">
         ...
         <img src="imagenes/PastaA.jpg" alt="">

         </div>
         <div class="card_info">
            <div class="info">
               <p class="title"> Pasta Alfredo </p>
            ...
            <div class="contenido">
               <p class="tittle">Ingredientes</p>
               <ul class="list">
                  <li>250g de pasta (espagueti, fettuccine, etc.)</li>
            ...
            <div class="accion">
               <a href="VisualizarReU.html" class="btn-2"> Ver receta </a>
            </div>
         </div>
      </div>
      <div class="card">
         <div class="card_landing">
         <img src="imagenes/Tama.jpg" alt="">
         ...
         <div class="card_info">
            ...
            <div class="contenido">
               <p class="tittle">Ingredientes</p>
               <ul class="list">
                  <li>200 gramos de tomatillos.</li>
                  <li>300 gramos de carne de cerdo.</li>
                  <li>1 cebolla.</li>
                  <li>Cilantro.</li>
                  <li>Aceite</li>
                  <li>Sal y pimienta al gusto</li>
                  <li>20 hojas de mazorca de maíz.</li>
               </ul>
            </div>
            <div class="accion">
               <a href="#" class="btn-2"> Ver receta </a>
            </div>
         </div>
      </div>
   </div>
 ...
 <section class="recetas">
  ...
  <div class="alinear">
     <div class="card">
        <div class="card_landing">
        <img src="imagenes/baba.jpg" alt="">

        </div>
        <div class="card_info">
           <div class="info">
              <p class="title"> Baba ganoush </p>
              <div class="description">
                 <div class="item">
                    <i class="fa-regular fa-clock"></i>
                    <p>90 minutos</p>
           ...
           <div class="contenido">
              ...
              <ul class="list">
                 <li>2 berenjenas</li>
                 <li>1 ajo o 2 si prefieres</li>
                 <li>1,5 cucharadas de zumo de limón</li>
                 <li>1 cucharada de tahini</li>
                 <li>60 ml de aceite</li>
                 <li>Sal y pimienta al gusto</li>
              </ul>
           </div>
           <div class="accion">
              <a href="visualizarRe.html" class="btn-2"> Ver receta </a>
           </div>
        </div>
     </div>
     <div class="card">
        <div class="card_landing">
        <img src="imagenes/Tira.jpg" alt="">

        </div>
        <div class="card_info">
           <div class="info">
              <p class="title"> Tiramisú </p>
              <div class="description">
                 <div class="item">
                    <i class="fa-regular fa-clock"></i>
                    <p>120 minutos</p>
           ...
           <div class="contenido">
              <p class="tittle">Ingredientes</p>
              <ul class="list">
               <li>250 ml Amaretto</li>
               <li>60 g Extracto de vainilla</li>
               <li>1,5 cucharadas de zumo de limón</li>
               <li>15 ml Queso mascarpone</li>
               <li>Café espresso</li>
               <li>Cocoa para espolvorearo</li>
              </ul>
           </div>
           <div class="accion">
              <a href="#" class="btn-2"> Ver receta </a>
